                  ...
                  <div className="absolute left-full top-0 flex w-16 justify-center pt-5">
                    ...
                    >
                      <span className="sr-only">
                        {t("components.molecules.sidebar.sidebar.spanFermer")}
                      </span>
                      <XMarkIcon
                      ...
                      {user.roles.includes("ROLE_MANAGER") && (
                        <li>
                          <div className="text-xs font-semibold leading-6 text-gray-400">
                            {t(
                              "components.molecules.sidebar.sidebar.lesVeterinaires",
                            )}
                          </div>
  ...
  return (
    <>
      <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
        ...
        >
          <span className="sr-only">
            {t("components.molecules.sidebar.topSidebar.spanOpenSideBar")}
          </span>
        ...
        <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 justify-end">
          <div className="flex items-center gap-x-4 lg:gap-x-6">
            ...
            >
              <span className="sr-only">
                {t(
                  "components.molecules.sidebar.topSidebar.voirLesNotifications",
                )}
              </span>
            ...
            <Menu as="div" className="relative">
              <Menu.Button className="-m-1.5 flex items-center p-1.5">
                <span className="sr-only">
                  {t(
                    "components.molecules.sidebar.topSidebar.ouvrirMenuUtilisateurs",
                  )}
                </span>
                <img
