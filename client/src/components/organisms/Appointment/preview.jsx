        ...
        <dl className="flex flex-wrap pb-6">
          <div className="flex-auto pl-6 pt-6">
            <dt className="text-sm font-semibold leading-6 text-gray-900 flex">
              ...
              <span className="ml-3">{displayDay(appointment?.date)}</span>
            </dt>
            <dd className="mt-1 text-base font-semibold leading-6 text-gray-900 flex items-center justify-between">
          ...
          <div className="mt-4 flex w-full flex-none gap-x-4 px-6">
            ...
            <dd className="text-sm leading-6 text-gray-500">
              <time dateTime="2023-01-31">{appointment.pet.name}</time>
            </dd>
          </div>
          <div className="mt-4 flex w-full flex-none gap-x-4 px-6">
            <dt className="flex-none">
