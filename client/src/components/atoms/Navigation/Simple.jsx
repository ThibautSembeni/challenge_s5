// const steps = [
//     { id: "1", name: "Informations", href: "#", status: "complete" },
//     { id: "2", name: "Vétérinaire", href: "#", status: "current" },
//     { id: "3", name: "Date et heure", href: "#", status: "upcoming" },
//     { id: "4", name: "Récapitulatif", href: "#", status: "upcoming" },
// ];
export default function Simple({ steps }) {
  return (
