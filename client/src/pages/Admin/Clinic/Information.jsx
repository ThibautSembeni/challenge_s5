...
import {
  createComplementaryInformation, getAllClinicsByManager,
  getOneClinics,
  updateOneClinics
                      ...
                      <div key={clinic.clinicInfo.uuid} className="px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mb-20">
                          <div className="max-w-7xl gap-x-8 gap-y-10 mt-10">
                            <form onSubmit={(event) => handleSubmitInformation(event, clinic.clinicInfo.uuid)}>
                        ...
                        <div className="mb-32 border-b border-gray-200 pb-10">
                          <ComplementaryInformationComponent complementaryInformationsProps={clinic.clinicInfo.clinicComplementaryInformation} title={false} admin={true} />
                        </div>
                      </div>
                    ))}
                  </main>
