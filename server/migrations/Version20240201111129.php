 ...
 */
final class Version20240201111129 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appointment_history (id INT NOT NULL, appointment_id INT DEFAULT NULL, veterinarian_id INT DEFAULT NULL, status JSON NOT NULL, datetime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE appointments (id INT NOT NULL, veterinarian_id INT DEFAULT NULL, user_id_id INT DEFAULT NULL, pet_id INT DEFAULT NULL, uuid UUID NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, reason TEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE clinic_complementary_information (id INT NOT NULL, clinic_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_25053A75CC22AD4 ON clinic_complementary_information (clinic_id)');
        $this->addSql('CREATE TABLE clinic_schedules (id INT NOT NULL, clinic_id INT DEFAULT NULL, timeslot_id INT DEFAULT NULL, day VARCHAR(20) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE clinics (id INT NOT NULL, manager_id INT DEFAULT NULL, uuid UUID NOT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(20) NOT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, city VARCHAR(50) NOT NULL, postal_code VARCHAR(15) NOT NULL, description TEXT DEFAULT NULL, is_actif BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE feedbacks (id INT NOT NULL, appointment_id INT DEFAULT NULL, rating INT NOT NULL, comment TEXT DEFAULT NULL, datetime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE schedules (id INT NOT NULL, veterinarian_id INT DEFAULT NULL, day VARCHAR(255) NOT NULL, start_time TIME(0) WITHOUT TIME ZONE DEFAULT NULL, end_time TIME(0) WITHOUT TIME ZONE DEFAULT NULL, type VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_313BDC8E804C8213 ON schedules (veterinarian_id)');
        $this->addSql('CREATE TABLE services (id INT NOT NULL, veterinarian_id INT DEFAULT NULL, description TEXT NOT NULL, price NUMERIC(10, 2) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE clinic_complementary_information ADD CONSTRAINT FK_25053A75CC22AD4 FOREIGN KEY (clinic_id) REFERENCES clinics (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE clinic_schedules ADD CONSTRAINT FK_CE878BE5CC22AD4 FOREIGN KEY (clinic_id) REFERENCES clinics (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE services ADD CONSTRAINT FK_7332E169804C8213 FOREIGN KEY (veterinarian_id) REFERENCES veterinarians (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
