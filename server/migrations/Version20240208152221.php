 ...
 */
final class Version20240208152221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appointments (id INT NOT NULL, veterinarian_id UUID DEFAULT NULL, user_id_id INT DEFAULT NULL, pet_id UUID DEFAULT NULL, schedules_id INT DEFAULT NULL, uuid UUID NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, reason TEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE payments (id INT NOT NULL, person_id INT DEFAULT NULL, clinic_id UUID DEFAULT NULL, stripe_payment_id VARCHAR(255) NOT NULL, amount DOUBLE PRECISION NOT NULL, status VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE pets (uuid UUID NOT NULL, user_id_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, species VARCHAR(255) NOT NULL, breed VARCHAR(255) NOT NULL, birthdate DATE NOT NULL, medical_history TEXT DEFAULT NULL, PRIMARY KEY(uuid))');
        ...
        $this->addSql('CREATE TABLE veterinarians (uuid UUID NOT NULL, clinic_id UUID DEFAULT NULL, lastname VARCHAR(100) NOT NULL, firstname VARCHAR(100) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(20) DEFAULT NULL, specialties VARCHAR(255) DEFAULT NULL, PRIMARY KEY(uuid))');
